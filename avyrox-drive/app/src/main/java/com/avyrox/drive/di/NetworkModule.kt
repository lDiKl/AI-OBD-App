...
import com.avyrox.drive.data.network.ApiService
import com.avyrox.drive.data.network.AuthInterceptor
import com.avyrox.drive.data.network.ScanApiService
import com.avyrox.drive.data.network.ShopsLeadsApiService
import com.avyrox.drive.data.network.SubscriptionApiService
...
object NetworkModule {
    ...
    @Provides @Singleton
    fun provideShopsLeadsApiService(retrofit: Retrofit): ShopsLeadsApiService =
        retrofit.create(ShopsLeadsApiService::class.java)
}
